...
function game(userChoice){
 ...
 const pcClick = getPcChoice();
 var getPcClicking = ["rcokPc", "paperPc", "scissorsPc"];
 var name2 = pcClick + getPcChoice
     if ("Rock"){
         document.getElementById("rockPc").style.backgroundColor="red";
     }
     if ("Paper"){
         document.getElementById("paperPc").style.backgroundColor="red";
     }
